...
<head>
    ...
    <title>LOGIN</title>
    <link rel="stylesheet" href="{{asset('css/md/css/mdb.min.css')}}">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form>
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="username" name="username" class="form-control form-control-lg" placeholder="Tên tài khoản" />
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            <button id="submitButton" type="button" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Login</button>
